package com.cloud.rabbitmq.client.test;



import com.cloud.rabbitmq.client.EventControlConfig;
import com.cloud.rabbitmq.client.EventProcesser;
import com.cloud.rabbitmq.client.EventTemplate;
import com.cloud.rabbitmq.client.exception.SendRefuseException;
import com.cloud.rabbitmq.client.impl.DefaultEventController;
...
public class RabbitMqTest{
    ...
    //rabbitmq主机地址
    private String defaultHost = "10.0.0.64";
    //交换器名称
